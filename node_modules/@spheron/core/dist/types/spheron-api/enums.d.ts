...
declare enum ComputeTypeEnum {
    SPOT = "spot",
    DEMAND = "demand"
}
export { ProjectTypeEnum, DeploymentEnvironmentStatusEnum, ProjectStateEnum, NodeVersionEnum, FrameworkEnum, DomainTypeEnum, DomainApplicationTypeEnum, DeploymentStatusEnum, AppTypeEnum, ProviderEnum, ClusterStateEnum, InstanceStateEnum, HealthStatusEnum, MarketplaceCategoryEnum, InstanceLogType, PersistentStorageClassEnum, ClusterProtocolEnum, ComputeTypeEnum, };
